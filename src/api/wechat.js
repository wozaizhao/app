...
export const wxGetLocalImgData = (localId) => {
    return new Promise((resolve, reject) => {
        wx.getLocalImgData({
            localId, // 图片的localID
            success: function (res) {
...
export const setAppMessageShareData = (params) => {
    return new Promise((resolve, reject) => {
...
export const setTimelineShareData = (params) => {
    return new Promise((resolve, reject) => {
...
export const setMenuShareAppMessage = (params) => {
    return new Promise((resolve, reject) => {
...
export const setMenuShareTimeline = (params) => {
    return new Promise((resolve, reject) => {
